...
/**
 * Output to the console in colour
 */
public class Output_TERM_COLOR extends Output {
    private Formatter_TERM_COLOR formatter = new Formatter_TERM_COLOR();
     ...
     */
    public Output_TERM_COLOR(String name) {
