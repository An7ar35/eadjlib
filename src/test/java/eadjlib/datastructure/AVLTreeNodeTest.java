...
public class AVLTreeNodeTest {
    ...
    public void height() throws Exception {
        AVLTreeNode a=  new AVLTreeNode<Integer>( 1 );
        AVLTreeNode b=  new AVLTreeNode<Integer>( 2 );
        AVLTreeNode c=  new AVLTreeNode<Integer>( 3 );
        AVLTreeNode d=  new AVLTreeNode<Integer>( 4 );
        AVLTreeNode e=  new AVLTreeNode<Integer>( 5 );
    ...
    public void compareTo() throws Exception {
        AVLTreeNode a=  new AVLTreeNode<Integer>( 0 );
        AVLTreeNode b=  new AVLTreeNode<Integer>( 0 );
        AVLTreeNode c=  new AVLTreeNode<Integer>( 10 );
        AVLTreeNode d=  new AVLTreeNode<Integer>( -10 );
